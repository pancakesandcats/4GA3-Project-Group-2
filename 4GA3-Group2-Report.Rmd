...
ggplot(df_race, aes(fill = white_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas White Population Distribution")
```
...
ggplot(df_race, aes(fill = black_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas Black Population Distribution")
```
...
ggplot(df_race, aes(fill = asian_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas Asian Population Distribution")
```
...
ggplot(df_race, aes(fill = american_indian_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas American Indian Population Distribution")
```
...
ggplot(df_race, aes(fill = pacific_islander_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas Pacific Islander Population Distribution")
```
...
ggplot(df_race, aes(fill = food_stamp_p)) + 
  ...
  theme_bw() +
  scale_fill_viridis_c(option = "turbo") +
  labs(title = "Map of Texas Food Stamp Usage Distribution")
```
